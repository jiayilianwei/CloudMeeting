    ...
    static class Program
    {
        ...
        static void Main()
        {
            try
            {
                ...
                string path1= string.Format("视频文件\\{0}", Program.ChatGroupA.GroupID);
                string path2 = string.Format("视频文件\\{0}", Program.ChatGroupB.GroupID);
                Directory.CreateDirectory(path1);
                Directory.CreateDirectory(path2);
                string path3 = string.Format("音频文件\\{0}", Program.ChatGroupA.GroupID);
                string path4 = string.Format("音频文件\\{0}", Program.ChatGroupB.GroupID);
        ...
        static void MicrophoneConnector4_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("音频文件\\{0}\\{4}.mp3", Program.GetRoomID("004"), "004");
        ...
        static void DynamicCameraConnector4_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("视频文件\\{0}\\{4}.mp4", Program.GetRoomID("004"), "004");
        ...
        static void MicrophoneConnector3_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("音频文件\\{0}\\{3}.mp3", Program.GetRoomID("003"), "003");
        ...
        static void DynamicCameraConnector3_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("视频文件\\{0}\\{3}.mp4", Program.GetRoomID("003"), "003");
        ...
        static void MicrophoneConnector2_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("音频文件\\{0}\\{2}.mp3", Program.GetRoomID("002"), "002");
        ...
        static void DynamicCameraConnector2_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("视频文件\\{0}\\{2}.mp4", Program.GetRoomID("002"), "002");
        ...
        static void MicrophoneConnector1_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("音频文件\\{0}\\{1}.mp3", Program.GetRoomID("001"), "001");
        ...
        static void DynamicCameraConnector1_ConnectEnded(ConnectResult result)
        {
            try
            {
                ...
                Thread.Sleep(500);
                string path = string.Format("视频文件\\{0}\\{1}.mp4", Program.GetRoomID("001"), "001");
